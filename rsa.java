...
//Enter the message to be encrypted: helloram
//Enter the first prime number (p): 2
//Enter the second prime number (q): 3
//Original Message is: helloram
//n (modulus): 6
//m (Euler's totient function): 2
//e (public exponent): 0
//d (private exponent): 1
//Encrypted Message is: 1 1 1 1 1 1 1 1 
